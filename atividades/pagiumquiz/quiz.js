    ...
    main.innerHTML = `
        <section class="pergunta">
            ...
            <h2 id="t">${quiz.questions[pergunta-1].question}</h2>
                <section></section>
            <div class="prog">
                <div class="b" id="0"></div>
                <div class="b" id="2"></div>
                <div class="b"  id="3"></div>
                <div class="b"  id="4"></div>
                <div class="b" id="5"></div>
                <div class="b"  id="6"></div>
                <div class="b" id="7"></div>
                <div class="b" id="8"></div>
                <div class="b" id="9"></div>
                <div class="b" id="10"></div>
            </div> 
        </section>
